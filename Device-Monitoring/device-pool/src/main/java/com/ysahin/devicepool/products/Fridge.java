 ...
 * between 0 and 100. if generated random number is grater then 80, alert
...
@Slf4j
public class Fridge extends Device implements IDevice {

	public Fridge(String serialNumber) {
		this.setId(String.valueOf(ProductTypes.FRIDGE.name() + "-" + serialNumber));
		this.setName(ProductTypes.FRIDGE.getValue());
		this.setType(ProductTypes.FRIDGE.ordinal());
