 ...
 * between 0 and 100. if generated random number is grater then 50, alert
...
@Slf4j
public class Ups extends Device implements IDevice {

	public Ups(String serialNumber) {
		this.setId(String.valueOf(ProductTypes.UPS.name() + "-" + serialNumber));
		this.setName(ProductTypes.UPS.getValue());
		this.setType(ProductTypes.UPS.ordinal());
